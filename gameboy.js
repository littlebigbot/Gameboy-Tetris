...
function tetrisGame(){
	...
	if(game.curPiece.num == 0) game.grid[game.curPiece.rVars[game.curPiece.vtn][0][0] + game.curPiece.offsetX][game.curPiece.rVars[game.curPiece.vtn][0][1]].changeState('active').changeType('shape' + (game.curPiece.num + 1) + 'a');
	else game.grid[game.curPiece.rVars[game.curPiece.vtn][0][0] + game.curPiece.offsetX][game.curPiece.rVars[game.curPiece.vtn][0][1]].changeState('active').changeType('shape' + (game.curPiece.num + 1));
	...
	if(game.curPiece.num == 0) game.grid[game.curPiece.rVars[game.curPiece.vtn][3][0] + game.curPiece.offsetX][game.curPiece.rVars[game.curPiece.vtn][3][1]].changeState('active').changeType('shape' + (game.curPiece.num + 1) + 'b');
	else game.grid[game.curPiece.rVars[game.curPiece.vtn][3][0] + game.curPiece.offsetX][game.curPiece.rVars[game.curPiece.vtn][3][1]].changeState('active').changeType('shape' + (game.curPiece.num + 1));
	
	if(game.nextPiece.num == 0) game.nextGrid[game.nextPiece.rVars[0][0][0]][game.nextPiece.rVars[0][0][1]].changeState('active').changeType('shape' + (game.nextPiece.num + 1) + 'a');
	else game.nextGrid[game.nextPiece.rVars[0][0][0]][game.nextPiece.rVars[0][0][1]].changeState('active').changeType('shape' + (game.nextPiece.num + 1));
	...
	if(game.nextPiece.num == 0) game.nextGrid[game.nextPiece.rVars[0][3][0]][game.nextPiece.rVars[0][3][1]].changeState('active').changeType('shape' + (game.nextPiece.num + 1) + 'b');
	else game.nextGrid[game.nextPiece.rVars[0][3][0]][game.nextPiece.rVars[0][3][1]].changeState('active').changeType('shape' + (game.nextPiece.num + 1));
...
function displayKeyCode(evt) {
	...
	$('.txtChar').each(function(index){
		if( ( String.fromCharCode(charCode) == $(this).val() || keyCodes[charCode] == $(this).val() )&& $(this) != textBox) exit = true;
	});
	if(!exit){
		textBox.val(String.fromCharCode(charCode));
		if(keyCodes.hasOwnProperty(charCode)) textBox.val(keyCodes[charCode]);
		
		if(evt.srcElement.name == 'upConfig') upKey = charCode;
		else if(evt.srcElement.name == 'rightConfig') rightKey = charCode;
		else if(evt.srcElement.name == 'downConfig') downKey = charCode;
		else if(evt.srcElement.name == 'leftConfig') leftKey = charCode;
		else if(evt.srcElement.name == 'bConfig') bKey = charCode;
		else if(evt.srcElement.name == 'aConfig') aKey = charCode;
		else if(evt.srcElement.name == 'selectConfig') selectKey = charCode;
		else if(evt.srcElement.name == 'startConfig') startKey = charCode;
	}
